...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class KoinLibraryAccessors extends SubDependencyFactory {
        ...
        private final KoinKoinLibraryAccessors laccForKoinKoinLibraryAccessors = new KoinKoinLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>koin.koin</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public KoinKoinLibraryAccessors getKoin() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForKoinKoinLibraryAccessors;
        }
    ...
    public static class KoinAndroidxLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>viewmodel</b> with <b>org.koin:koin-androidx-viewmodel</b> coordinates and
     ...
     */
    @Deprecated
    public static class KoinKoinLibraryAccessors extends SubDependencyFactory {

        public KoinKoinLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>android</b> with <b>org.koin:koin-android</b> coordinates and
         * with version reference <b>koinAndroid</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
        ...
        public Provider<MinimalExternalModuleDependency> getAndroid() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("koin.koin.android");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>koinAndroid</b> with value <b>2.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
